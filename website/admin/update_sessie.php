...
<html lang="en">
  ...
  <body class="h-100">
    ...
    <div class="h-100 container content-border admin-content">
        ...
        <section>
        <h1>Edit session</h1>
        <form method="post" action="update_sessie_code.php">
        <div class="form-group">
                <label for="title">Session ID</label>
                <input type="text" class="form-control" name="idsessie" readonly value="<?php print($sessie)?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input type="submit" class="btn btn-default" name="submit" value="Edit session">
            </div>
        </form>
        </section>        
        </div>
    ...
    <footer class="row">
            <section class="col-lg-3 col-xs-1 col-sm-4 col-md-4 footer-content">
                ...
                <div class="row footer-items">
                <form method="post" action="newsletter_code.php">
